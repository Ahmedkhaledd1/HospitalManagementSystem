	...
	public void dateMenuSelect(ActionEvent event) {
		...
		if(doc!=null &&date!=null) {
			...
			timesMenu.setItems( FXCollections.observableArrayList(sys.DisplaySchedule(doc, date)));
			 newTimesMinue.setItems( FXCollections.observableArrayList(sys.DisplaySchedule(doc, date)));
			 newDateMenu.setItems(FXCollections.observableArrayList("Saturday","Sunday","Monday","Tuesday","Wednesday","Thursday","Friday"));
